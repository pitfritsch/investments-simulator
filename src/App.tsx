...
function App() {
  ...
  const recalculate = useCallback(() => {
    if (!initialValue || !monthlyValue || !interest || !term) return;
    ...
    const monthlyInterest = returnNumberFromFormattedValue(interest) / 12 / 100;
    ...
    for (let index = 0; index <= totalMonths; index++) {
      ...
      const monthYield = lastMonth.totalValueWithYield * monthlyInterest;
  ...
  }, [initialValue, monthlyValue, interest, term]);
      ...
      <div>
        ...
        <div className="flex-column">
          ...
          <input
            ...
            id="interest"
            value={interest}
            onChange={(e) => setInterest(VMasker.toMoney(e.target.value))}
          />
        </div>
        <br />
